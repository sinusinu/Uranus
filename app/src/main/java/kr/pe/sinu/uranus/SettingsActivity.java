    ...
    public class SettingsItemClickListener implements SettingsAdapter.OnItemClickListener {
        ...
        public void onItemClick(String key, int position) {
            ...
            switch (key) {
                ...
                case "about":
                    try {
                        startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("https://github.com/sinusinu/Uranus")));
                    } catch (Exception ignored) {
                        Toast.makeText(SettingsActivity.this, R.string.settings_error_no_browser, Toast.LENGTH_SHORT).show();
                    }
                    break;
                case "license":
