...
public class MediaPlaybackService extends Service {
    ...
    public static final int PLAYBACK_SPEED_0P25X = -4;
    public static final int PLAYBACK_SPEED_0P50X = -3;
    public static final int PLAYBACK_SPEED_0P75X = -2;
    public static final int PLAYBACK_SPEED_0P90X = -1;
    public static final int PLAYBACK_SPEED_1X    =  0;
    public static final int PLAYBACK_SPEED_1P10X =  1;
    public static final int PLAYBACK_SPEED_1P25X =  2;
    public static final int PLAYBACK_SPEED_1P50X =  3;
    public static final int PLAYBACK_SPEED_1P75X =  4;
    public static final int PLAYBACK_SPEED_2X    =  5;
    ...
    public void setPlaybackSpeed(int speed) {
        ...
        switch (playbackSpeed) {
            ...
            case PLAYBACK_SPEED_0P75X:
                ...
                break;
            case PLAYBACK_SPEED_0P90X:
                player.setPlaybackSpeed(0.90f);
                break;
            case PLAYBACK_SPEED_1P10X:
                player.setPlaybackSpeed(1.10f);
                break;
    ...
    private void updateNotification() {
        var notif = buildNotificationBuilder().build();
    ...
    private NotificationCompat.Builder buildNotificationBuilder() {
        ...
        return new NotificationCompat.Builder(this, CHANNEL_ID)
                ...
                .setContentTitle(getString(R.string.service_empty_notification_title))
                .setContentText("")
